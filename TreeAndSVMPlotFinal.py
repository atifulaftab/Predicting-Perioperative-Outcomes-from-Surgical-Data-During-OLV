...
# print(metrics.classification_report(y_test, y_pred))
 ...
 #return [acc_score,f1_avg, std_avg, depth,n_estimator,estimator]
 return [acc_score,f1_avg, depth,n_estimator,estimator]
...
data=data[1:,[1,2,3,4,5,6,7,8,14,15,16,17,18,19,20,21]]
...
# [acc_score, f1_avg,std_avg, depth,n_estimator,estimator] = result_rf(X_train_res,y_train_res, X_test,y_test)
...
# [acc_score, f1_avg,std_avg, depth,n_estimator,estimator] = result_rf(X_train_post,y_train_res, X_test_post,y_test)
# print("Accuracy Score:",acc_score.mean())
# print("F1 Score:",f1_avg.mean())
# print("Standard Deviation for F1 Score:",std_avg.mean())
# print('Max_Depth:',depth.mean())
